...
canvas.place(x=310,y=230,width=440,height=350)
...
tk.Button(root, text='Submit',width=14,bg='green',fg='black',font=18,command=login).place(x=350,y=470)  
# tk.Button(root, text='Forget password',width=14,bg='light blue',fg='black',command=forget,font=18).place(x=330,y=520)
tk.Button(root, text='Create Account',width=14,bg='orange',fg='black',font=18,command=registration).place(x=550,y=470)  
